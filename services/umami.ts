...
const mergeData = (allResults: UmamiResponse[]): UmamiResponse => {
  ...
  allResults.forEach((result) => {
    ...
    if (
      result?.websiteStats?.pageviews?.value !== undefined &&
      combined.websiteStats.pageviews.value !== undefined
    ) {
      combined.websiteStats.pageviews.value +=
        result.websiteStats.pageviews.value;
    }
    if (
      result?.websiteStats?.visitors?.value !== undefined &&
      combined.websiteStats.visitors.value !== undefined
    ) {
      combined.websiteStats.visitors.value +=
        result.websiteStats.visitors.value;
    }
    if (
      result?.websiteStats?.visits?.value !== undefined &&
      combined.websiteStats.visits.value !== undefined
    ) {
      combined.websiteStats.visits.value += result.websiteStats.visits.value;
    }
    if (
      result?.websiteStats?.events?.value !== undefined &&
      combined.websiteStats.events.value !== undefined
    ) {
      combined.websiteStats.events.value += result.websiteStats.events.value;
    }
    if (
      result?.websiteStats?.countries?.value !== undefined &&
      combined.websiteStats.countries.value !== undefined
    ) {

    ...
    if (body.type === "REPLY_NOTIFICATION") {
      ...
      const htmlReply = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            ...
            <a href="https://onicagustino.my.id/chat" style="${buttonStyle}">Buka Chat Room</a>
          </div>
          <div style="${footerStyle}">
            Sent by Onic Agustino Portfolio System • www.onicagustino.my.id • Indonesia
          </div>
        </div>
      `;

      await transporter.sendMail({
        from: `"Onic Agustino" <${process.env.NODEMAILER_EMAIL}>`,
        to: targetEmail,
      ...
      const htmlNewChat = `
        <div style="${mainContainer}">
          ...
          <div style="${bodyStyle}">
            <p style="font-size: 16px; margin-top: 0;">Hi Onic,</p>
            ...
            <a href="https://onicagustino.my.id/chat" style="${buttonStyle}">Balas Sekarang</a>
          </div>
          <div style="${footerStyle}">

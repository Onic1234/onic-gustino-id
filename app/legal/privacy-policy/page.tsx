...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Onic Agustino's Portfolio App regarding TikTok API integration",
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            developer&apos;s (Onic Agustino) public TikTok content for
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            contact the developer at: <strong>onic.agustino@gmail.com</strong>.
          </p>
        </section>
      </div>
    </Container>

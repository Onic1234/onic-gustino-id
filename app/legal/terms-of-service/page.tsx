...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service for Onic Agustino's Portfolio App regarding TikTok API usage",
    ...
    <Container data-aos="fade-up">
      ...
      <div className="mt-8 space-y-8 leading-relaxed text-neutral-700 dark:text-neutral-300">
        ...
        <section className="space-y-4">
          ...
          <p>
            This website is a personal portfolio created to showcase Onic
            Agustino&apos;s professional projects, technical skills, and social
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            the property of Onic Agustino. Content displayed through the TikTok
